#!/bin/bash
#
# data_exp_2b.sh — non-critical-only attacks on navigate_to_goal (box2), WITH mitigation.
#
...
#   exp_2b.csv       — summary row (appended each run)
#   exp_2b_psi.csv   — psi sampled at 100 Hz
#   exp_2b_delta.csv — delta sampled at 100 Hz
#
# Usage:
#   ./auto_runs/data_exp_2b.sh
#   ./auto_runs/data_exp_2b.sh configs/experiment_2b.json ../results/framework_correctness/exp_2b.csv
#
set -u
...
CONFIG="${1:-configs/experiment_2b.json}"
RESULT="${2:-../results/framework_correctness/exp_2b.csv}"
